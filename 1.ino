...
int tar_x[] = {0,20,10,  0,20,10,  0,20,10,  0,20,10,  0,20,10,  0,20,10,  0,20,10};
int tar_y[] = {0, 0,20,  0, 0,20,  0, 0,20,  0, 0,20,  0, 0,20,  0, 0,20,  0, 0,20};*/


int tar_x[] = {0,  20,10,  20,10,  20,10,  20,10,  20,10,  20,10,  20,10};
int tar_y[] = {0,   0,20,   0,20,   0,20,   0,20,   0,20,   0,20,   0,20};
...
float calculate_dist(float x1, float y1, float x2, float y2 ) {         //distance formula
  float Dist = sqrt(pow(y2 - y1, 2) + pow(x2 - x1, 2));
  return Dist;
}

float calculate_angle(float x1, float y1, float x2, float y2, float Heading) {  //Transformation Matrix
  float Angle =0;
